...
namespace SharePointConnect
{
    ...
    public class Registration
    {
        ...
        public Registration(Guid guid, string contactNo, string eventNo, string eventTemplateNo, string courseNo,string articleNo , int status) {
            this.guid = guid;
        ...
        public Registration(Dictionary<string, object> registration, string filePath) {
            ...
            foreach (KeyValuePair<string, object> pair in registration) {
                if (pair.Value != null) {
                    switch (pair.Key) {
                        case "GUID":
